...
export default function TicketsHeader() {
  return (
    <header className=" min-h-[420px] md:min-h-[520px] overflow-hidden">
      ...
      <div className="relative container mx-auto z-10 items-center grid grid-cols-1 md:grid-cols-2 gap-10 pt-20 md:pt-28 pb-12 md:pb-16 text-center px-4">
        <div>
          <h1
          ...
          <p className="mt-5 md:mt-6 text-base md:text-[18px] text-[#F5F5F5] font-normal max-w-[600px] mx-auto leading-relaxed">
