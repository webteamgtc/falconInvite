...
export default function EventSectionLast({ data }) {
    ...
    return (
        <section className="py-14 md:py-20 relative px-4 md:px-6">
            ...
            <div className="max-w-5xl mx-auto relative z-10">
                {/* Main title */}
                <h1
                    className="font-serif text-3xl md:text-4xl lg:text-6xl leading-[1.2] font-bold text-center tracking-wide uppercase"
                    style={{
                ...
                >
                    Annual Meeting & <br /> Golden Falcon Awards Night
                </h1>
                ...
                <p className="text-center text-xl md:text-xl  mt-4 max-w-xl mx-auto"
                    style={{
