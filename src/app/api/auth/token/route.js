...
//       timeout: 30000, // Increased to 30s to accommodate slow API responses
//       validateStatus: () => true,
//     });
...
export async function POST() {
  // If you still want to keep tokenResponse flow in frontend:
  // Return something stable (not used for auth if cookie is used)
  return Response.json(
